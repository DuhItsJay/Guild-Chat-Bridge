					...
					fields: [
						...
						},
						{
							...
							value: [
								...
								`Guild Channel: <#${this.discord.app.config.discord.channel.guild}>\n`,
								this.discord.app.config.discord.channel.officer ? `Officer Channel: <#${this.discord.app.config.discord.channel.officer}>\n` : '',

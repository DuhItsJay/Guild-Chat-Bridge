...
class Logger {
	/** *
	 * @summary discord side events in console
	 * {@link ../doc/img/discord_log.png | discordreply}
	 */
	discord(message) {
	...
	/** *
	 * @summary minecraft side events in console
	 * {@link ../doc/img/minecraft_log.png | minecraftreply}
	 */
	minecraft(message) {
